...
export interface LearningTrack { id: string; name: string; category: string; progress: number; hours: number; skills?: Record<string, number>; courseUrl?: string; currentCourseId?: string; currentModule?: string; currentLesson?: string; nextAction?: string; keyTakeaway?: string; practicePlan?: string; studyNotes?: string; courseProgress?: Record<string, number>; }
